		...
		mysql.getConnection((error, conn) => {
			...
			conn.query(
				...
				(error, result, fields) => {
					...
					sendEmail(dataCliente).catch((error) => console.log(error));
					sendEmail(dataBarbeiro).catch((error) => console.log(error));
					sendMessageWP(dataCliente).catch((error) => console.log(error));
					sendMessageWP(dataBarbeiro).catch((error) => console.log(error));
					...
					conn.query(
						...
						(error, result, fields) => {
							...
							result.map((e) => {
								...
								sendEmail(dataProprietario).catch((error) => console.log(error));
								sendMessageWP(dataProprietario).catch((error) => console.log(error));
							})
					})
				}
			)
